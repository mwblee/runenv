...
hg38_annotation_dir="/opt/hg38_annovar/"
...
then
  ...
  echo "Running table_annovar.pl $cohort_vcf $hg38_annotation_dir \
     ...
     -remove \
     -protocol refGene,cytoBand,exac03,exac03nontcga,exac03nonpsych,avsnp150,dbnsfp33a,dbnsfp31a_interpro,dbscsnv11,cosmic70,esp6500siv2_ea,esp6500siv2_aa,esp6500siv2_all,gnomad_exome,gnomad_genome,AFR.sites.2015_08,ALL.sites.2015_08,AMR.sites.2015_08,EUR.sites.2015_08,mcap,revel,clinvar_20170905 \
     -operation gx,r,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f \
     -nastring . \
     --thread $numcores \
     -vcfinput"
  echo "[TIME: ANNOVAR]"
  time /opt/annovar/table_annovar.pl $cohort_vcf $hg38_annotation_dir \
     -buildver hg38 \
     -out ${outDir}/${1}_annovar \
     -remove \
     -protocol refGene,cytoBand,exac03,exac03nontcga,exac03nonpsych,avsnp150,dbnsfp33a,dbnsfp31a_interpro,dbscsnv11,cosmic70,esp6500siv2_ea,esp6500siv2_aa,esp6500siv2_all,gnomad_exome,gnomad_genome,AFR.sites.2015_08,ALL.sites.2015_08,AMR.sites.2015_08,EUR.sites.2015_08,mcap,revel,clinvar_20170905 \
